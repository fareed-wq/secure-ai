...
const SafetyComparison = () => {
  ...
  return (
    <div className="safety-section w-full mt-12 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
      ...
      <div className="safety-reassurance max-w-5xl mx-auto mt-6 bg-slate-900/50 border border-slate-800 rounded-xl p-4 flex items-center justify-center gap-3 text-sm text-slate-400 text-center">
      ...
      {/* FAQ Section */}
      <div className="faq-section max-w-3xl mx-auto mt-16 text-left animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
        <div className="text-center mb-8">
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className={`faq-card transition-colors rounded-lg border overflow-hidden ${
isOpen
? 'faq-card-open bg-slate-800/80 border-indigo-500/30'
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="faq-question font-semibold text-slate-200 text-sm md:text-base pr-4">{faq.question}</span>
                  </div>
                ...
                >
                  <div className="faq-answer p-4 md:px-5 md:pb-5 pt-0 text-slate-400 text-sm leading-relaxed ml-7 md:ml-8">
                    {faq.answer.split('\n').map((line, i) => (
