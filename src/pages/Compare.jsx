...
const Compare = () => {
  return (
    <div className="space-y-6 text-slate-200">
      <div>
        <h1 className="text-3xl font-bold text-white tracking-tight">Report Comparison</h1>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          <div className="flex-1 w-full">
            ...
            <select className="block w-full bg-slate-950 border border-slate-700 rounded-lg py-3 px-4 text-white focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div className="p-6">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 bg-slate-800/50 border border-slate-700 rounded-xl opacity-60">
              <span className="bg-slate-600 text-white text-xs font-bold px-2 py-1 rounded">UNCHANGED</span>
