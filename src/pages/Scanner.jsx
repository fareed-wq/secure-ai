        ...
        <AnimatePresence mode="wait">
          ...
          {scanState === 'view-report' && reportData && (
            ...
            >
              ...
              {/* MANDATORY PDF HEADER */}
              <div className="hidden print:block mb-8 pb-4 border-b-2 border-slate-300 print:text-slate-900">
                <div className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-1">
                  Report generated by urlscanonline.com
                </div>
                <h1 className="text-3xl font-black mb-2">{url}</h1>
                <div className="flex justify-between items-end">
                  <div className="text-sm font-medium">
                    <strong>Scan Date:</strong> {new Date(reportData.scan_start || Date.now()).toLocaleString()}
                  </div>
                  <div className="text-xl font-bold">
                    Overall Security Score: {reportData.score}/100
                  </div>
                </div>
              </div>
