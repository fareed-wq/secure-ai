        ...
        <AnimatePresence mode="wait">
          ...
          {scanState === 'scanning' && (
            <motion.div
              ...
              className="max-w-2xl mx-auto mt-20 p-8 rounded-3xl bg-white/95 border border-slate-200 dark:bg-slate-900/95 dark:border-white/10 backdrop-blur-xl shadow-2xl overflow-hidden relative"
            >
              <div className="absolute inset-0 bg-slate-200/[0.2] dark:bg-slate-800/[0.2] bg-[size:20px_20px] text-slate-300/40 dark:text-slate-700/40" style={{backgroundImage: 'radial-gradient(circle, currentColor 1px, transparent 1px)'}}></div>
              ...
              <div className="flex flex-col items-center justify-center space-y-8 py-12 relative z-10">
                ...
                <div className="space-y-4 text-center w-full">
                  <h2 className="text-slate-900 dark:text-white font-bold text-lg">
                    Establishing Secure Uplink to <span className="text-indigo-600 dark:text-indigo-400 font-semibold">{url}</span>...
                  </h2>
                  <div className="text-slate-500 dark:text-slate-400 text-xs">Please wait while our engine performs passive analysis.</div>
                </div>
              </div>
            </motion.div>
          )}
