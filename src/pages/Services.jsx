...
import { Shield, Search, Lock, EyeOff, Mail, Globe, FileCheck, Key, XCircle, ChevronRight, History, CalendarClock, ArrowRightLeft } from 'lucide-react';
...
const Services = () => {
  useSEO({
    title: 'Security Scanner Capabilities & Security Assessments | URLScanOnline',
    description: 'Compare URLScanOnline Basic and Advanced scanner capabilities, explore scan history and comparison tools, and review available security audits and assessment services.',
    path: '/services'
  });
      ...
      <section className="relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 p-8 md:p-12 lg:p-16">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-lg text-slate-400 mb-10 max-w-2xl">
            ...
            our security services. Below is the comprehensive catalog of potential findings
            our platform assesses.
          </p>
