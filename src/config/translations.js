...
,
  "Open Port Detected": {
    ...
    problem: "An unexpected port is open to the public internet.",
    why: "Open ports are entry points into your server. Unnecessary ports increase the attack surface and can be exploited by hackers.",
    category: "Network Services"
  },
  "SMTP Service Exposed": {
    name: "Mail Server Exposed",
    problem: "A mail server port is publicly accessible.",
    why: "Exposed email ports can be targeted for spam relay, brute-force password guessing, or server software vulnerabilities.",
    category: "Network Services"
  },
  "FTP Service Exposed": {
    name: "Unencrypted File Transfer (FTP)",
    problem: "An unencrypted file transfer service is exposed.",
    why: "FTP sends passwords and files in plain text, allowing anyone on the network to intercept sensitive data.",
    category: "Network Services"
  },
  "SSH Service Exposed": {
    name: "Remote Management Exposed (SSH)",
    problem: "Remote management access is open to the public internet.",
    why: "If not protected with strong keys and IP restrictions, attackers can use automated tools to guess passwords and take control of your server.",
    category: "Network Services"
  },
  "Telnet Service Exposed": {
    name: "Obsolete Remote Access (Telnet)",
    problem: "An obsolete, unencrypted remote access service is running.",
    why: "Telnet provides zero encryption. Any passwords or commands typed over this connection can be stolen by network eavesdroppers.",
    category: "Network Services"
  },
  "Database Service Exposed": {
    name: "Database Directly Exposed",
    problem: "A backend database port is directly accessible from the internet.",
    why: "Databases should only be accessible to your web servers, never the public internet. This risks complete data theft and ransomware.",
    category: "Network Services"
  },
  "HTTP Service Exposed": {
    name: "Unencrypted Web Port (HTTP)",
    problem: "An unencrypted web server port is open.",
    why: "Traffic on this port is completely readable by network interceptors. It should strictly redirect visitors to a secure HTTPS connection.",
    category: "Network Services"
  }
};
